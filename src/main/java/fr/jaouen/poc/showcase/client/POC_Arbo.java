...
public class POC_Arbo implements EntryPoint {
	...
	public void onModuleLoad() {
		// ClientFactory contient toutes les vues et les accès aux services
		...
		// Add main panel into web page
		RootPanel.get().add(container);

		// Création de l'Activity Manager
		final MainActivityMapper activityMapper = new MainActivityMapper(clientFactory);
		...
		// historyHandler.register(placeController, eventBus, currentPlace);
		// historyHandler.handleCurrentHistory();

		// If this is the first activity to launch
		if (!activityMapper.isStartFirstActivity()) {
			// Start activity
			Activity activity = activityMapper.getActivity(currentPlace);
			activity.start(container, eventBus);
		}
